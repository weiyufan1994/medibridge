...
export const REASON_LABELS: Record<string, LocalizedText> = {
...
export const WEBHOOK_TYPE_LABELS: Record<string, LocalizedText> = {
...
export const EXCEPTION_ACTION_OPTIONS: ReadonlyArray<
...
export const RISK_MESSAGES: Record<string, LocalizedText> = {
