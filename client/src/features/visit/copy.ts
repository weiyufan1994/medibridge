...
const visitCopyByLang = {
  en: {
    ...
    historyRetentionNote: "Chat history is retained for 7 days.",
    ...
    translationBadgeText: "AI Translation",
    consultationEnded: "Consultation Ended",
    consultationTimeExceeded: "Time Exceeded",
    consultationLive: "Consultation Live",
    localTimeLabelShort: "Local",
    beijingTimeLabelShort: "Beijing",
    doctorWorkbenchTitle: "Doctor Workbench",
    triageSidebarTitle: "AI Triage Summary",
    triageRecommendationTitle: "AI Recommendation",
    doctorRoleFallback: "Doctor",
  ...
  zh: {
    ...
    translationBadgeText: "AI 翻译支持",
    consultationEnded: "会诊已结束",
    consultationTimeExceeded: "会诊超时",
    consultationLive: "会诊进行中",
    localTimeLabelShort: "当地时间",
    beijingTimeLabelShort: "北京时间",
    doctorWorkbenchTitle: "医生工作台",
    triageSidebarTitle: "AI 分诊摘要",
    triageRecommendationTitle: "AI 建议",
    doctorRoleFallback: "医生",
    ...
    loading: "加载中...",
    attachmentSelected: "已选择附件：{{fileName}}（上传功能即将开放）",
  },
} as const;
