export const DAYTIME_QUICK_TIME_SLOTS = [
  "09:00",
  "11:00",
  "14:00",
  "16:30",
...
export const FULL_DAY_QUICK_TIME_SLOTS = [
  "00:30",
  "06:00",
  "09:00",
  "14:00",
...
export function resolveAppointmentAvailabilityConfig(
...
export function formatDoctorAvailabilityHint(params: {
  ...
  const { allDayLabel, isTwentyFourHourDoctor, rangeLabel, rangeTemplate } =
    params;
