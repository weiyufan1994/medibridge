...
`{医院名称}/{科室名称}_医生详细信息_{YYYYMMDD}.xlsx`

例如：`复旦大学附属中山医院/呼吸科_医生详细信息_20260211.xlsx`
...
- **呼吸科**：20位医生（16位有效，3位跳过，1位失败）
  - 最后更新：2026-02-11
  - 文件：`复旦大学附属中山医院/呼吸科_医生详细信息_20260211.xlsx`
...
# 读取数据
df = pd.read_excel('复旦大学附属中山医院/呼吸科_医生详细信息_20260211.xlsx')
